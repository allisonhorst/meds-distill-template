...
For those wanting to take the distill/R websites path: this template acts as both a starting point for your site, and a tutorial on where & how to customize it. Please reach out to Allison for help getting your website started, and submit problems and suggestions as issues [here](https://github.com/allisonhorst/meds-distill-template). 

Some starting points:

- Follow along with the "Getting started with the MEDS distill template" instructions to set up your own distill website

- The "Weekly materials" section can be updated with your course materials, but also in this template serves the additional purpose of showing you how to customize some things on your page.
