---
title: "Module 1: Add/remove a site page"
---
...
**NOTE:** There are 10 toy module sections here, expecting that some teachers may want to have one page per week. You are encouraged to structure your course however you want - e.g. all of your course information could be on a single page, or you might have a different number of topics, or organize weekly.

<p style="color: #ba5e00"><b>TO UPDATE THIS PAGE:</b> Open and edit the <b>module_1.Rmd</b> file, in the project root, to delete this placeholder text and customize with your own!</p>
